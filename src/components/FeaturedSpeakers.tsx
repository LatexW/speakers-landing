...
function SpeakerCard({ name, city, org }: CardProps) {
  return (
    <div className="relative overflow-hidden rounded-[26px] ring-1 ring-white/10 bg-black/20 backdrop-blur-sm flex flex-col h-full">
      {/* Image */}
      ...
      {/* Gradient info panel */}
      <div
        className="relative z-[2] rounded-b-[26px] p-5 pt-6 text-black flex flex-col min-h-[190px]"
...
export default function FeaturedSpeakers() {
  return (
    <section className="relative z-10 mx-auto w-full max-w-7xl px-6 sm:px-8 pt-8 pb-10 -mt-40 sm:-mt-36 lg:-mt-32 bg-transparent">
      <h2 className="text-white text-[22px] sm:text-[34px] font-medium">Featured Speakers</h2>
